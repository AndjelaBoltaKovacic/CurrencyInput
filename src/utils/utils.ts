...
export const formatDefaultValue = (defaultValue: string | number) => defaultValue ? formatNumberInputWithDecimals(typeof defaultValue === 'number' ? defaultValue?.toString() : defaultValue) : ''